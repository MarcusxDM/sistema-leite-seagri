...
urlpatterns = [
    ...
    # path('gerar-qr-consumidor-menu/', views.generate_qr_menu, name='gerar-qr-consumidor-menu'),
    # path('gerar-qr-consumidor/', views.generate_qr_consumidor, name='gerar-qr-consumidor')
